...
var require_trim_repeated = __commonJS({
  "node_modules/trim-repeated/index.js"(exports, module) {
    "use strict";
...
var require_filename_reserved_regex = __commonJS({
  "node_modules/filename-reserved-regex/index.js"(exports, module) {
    "use strict";
...
var require_strip_outer = __commonJS({
  "node_modules/strip-outer/index.js"(exports, module) {
    "use strict";
    var escapeStringRegexp = require_escape_string_regexp();
...
var require_filenamify = __commonJS({
  "node_modules/filenamify/filenamify.js"(exports, module) {
    "use strict";
...
var require_filenamify_path = __commonJS({
  "node_modules/filenamify/filenamify-path.js"(exports, module) {
    "use strict";
...
var require_filenamify2 = __commonJS({
  "node_modules/filenamify/index.js"(exports, module) {
    "use strict";
    var filenamify = require_filenamify();
...
var require_stringify = __commonJS({
  "node_modules/braces/lib/stringify.js"(exports, module) {
    ...
    module.exports = (ast, options = {}) => {
      const stringify = (node, parent2 = {}) => {
        const invalidBlock = options.escapeInvalid && utils.isInvalidBrace(parent2);
  ...
  "node_modules/braces/lib/compile.js"(exports, module) {
    ...
    var compile = (ast, options = {}) => {
      const walk = (node, parent2 = {}) => {
        const invalidBlock = utils.isInvalidBrace(parent2);
        const invalidNode = node.invalid === true && options.escapeInvalid === true;
  ...
  "node_modules/ignore/index.js"(exports, module) {
    ...
    var Ignore = class {
      ...
      _t(path, cache, checkUnignored, slices) {
        ...
        return cache[path] = parent2.ignored ? parent2 : this._testOne(path, checkUnignored);
      }
      ignores(path) {
...
var require_git = __commonJS({
  "node_modules/gh-pages/lib/git.js"(exports, module) {
      ...
      return new Promise((resolve, reject2) => {
        ...
        child.on("close", (code) => {
          ...
          if (code) {
            ...
            reject2(new ProcessError(code, msg));
          } else {
            resolve(output);
          }
        });
    ...
    Git.clone = function clone(repo, dir2, branch, options) {
      return fs.exists(dir2).then((exists) => {
        if (exists) {
          return Promise.resolve(new Git(dir2, options.git));
        } else {
          return fs.mkdirp(path.dirname(path.resolve(dir2))).then(() => {
            const args = [
              "clone",
              repo,
              dir2,
...
var require_util2 = __commonJS({
  "node_modules/gh-pages/lib/util.js"(exports) {
    var path = require_path();
    ...
    function makeDir(path2, callback) {
      fs.mkdir(path2, (err) => {
        if (err) {
          fs.stat(path2, (err2, stat) => {
...
var require_lib2 = __commonJS({
  "node_modules/gh-pages/lib/index.js"(exports) {
    var path = require_path();
    var util = require_util();
    ...
    var Git = require_git();
    var copy = require_util2().copy;
    var getUser = require_util2().getUser;
    var log2 = util.debuglog("gh-pages");
    function getCacheDir(optPath) {
      const dir2 = findCacheDir({ name: "gh-pages" });
      if (!optPath) {
        return dir2;
      }
      return path.join(dir2, filenamify(optPath));
    }
    ...
    exports.publish = function publish(basePath, config, callback) {
      ...
      function done(err) {
        try {
          ...
          log2("Publish callback threw: %s", err2.message);
        }
      }
      try {
      ...
      return userPromise.then(
        (user) => getRepo(options).then((repo) => {
          ...
          log2("Cloning %s into %s", repo, clone);
          ...
          log2("Fetching %s", options.remote);
          return git.fetch(options.remote);
        }).then((git) => {
          log2("Checking out %s/%s ", options.remote, options.branch);
          ...
          if (options.nojekyll) {
            log2("Creating .nojekyll");
            fs.createFileSync(path.join(git.cwd, ".nojekyll"));
          }
          if (options.cname) {
            log2("Creating CNAME for %s", options.cname);
          ...
          if (options.tag) {
            ...
            return git.tag(options.tag).catch((error) => {
              log2(error);
              log2("Tagging failed, continuing");
              return git;
            });
          } else {
            return git;
